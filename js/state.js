...
export const LABEL = {
  en: {
    ...
    ui: {
      ...
      onboardHelp: "Help",
      onboardModalTitle: "Help & tips",
      onboardModalDesc: "Keep this nearby when you need a refresher.",
  ...
  cy: {
    ...
    ui: {
      ...
      closeFilters: "Cau hidlwyr",
      categoriesMoreFilters: "Mwy o hidlwyr ▾",
      categoriesFewerFilters: "Llai o hidlwyr ▴",
      onboardHelp: "Cymorth",
      onboardModalTitle: "Cymorth a chynghorion",
      onboardModalDesc: "Cadwch hwn gerllaw pan fydd angen atgoffa.",
      sessionTitle: "Sesiwn yma",
      newSession: "Newydd",
      clearFilters: "Clirio hidlwyr",
      clearFocus: "Clirio ffocws",
